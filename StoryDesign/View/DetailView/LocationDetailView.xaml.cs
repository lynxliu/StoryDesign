...
{
    public sealed partial class LocationDetailView : UserControl
    {
        ...
        {
            var dc = args.NewValue as LocationDetailViewModel;
        ...
        private void ListBox_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            UIManager.ShowMenu(() =>
            {
                ...
                {
                    var dc = DataContext as LocationDetailViewModel;
                    if (dc != null)
