...
{
    public sealed partial class StuffDetailView : UserControl
    {
        public StuffDetailView()
        {
        ...
        {
            var dc = args.NewValue as StuffDetailViewModel;
        ...
        private void ListBox_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            UIManager.ShowMenu(() =>
            {
                ...
                {
                    var dc = DataContext as StuffDetailViewModel;
                    if (dc != null)
        ...
        private void FunctionListBox_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            UIManager.ShowMenu(() =>
            {
                var contextFlyout = new MenuFlyout();
