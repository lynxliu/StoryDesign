...
namespace StoryDesign
{
    class MainViewModel : ViewModelBase
    {
        ...
        #endregion
        bool IsFit(string name, string filter)
        {

            if (string.IsNullOrEmpty(filter)) return true;
            if (name.IndexOf(filter, 0, StringComparison.OrdinalIgnoreCase) >= 0) return true;
            return false;
        }
        #region List Info
        ...
        ObservableCollection<ActorDetailViewModel> _ShowActorList = new ObservableCollection<ActorDetailViewModel>();
        public ObservableCollection<ActorDetailViewModel> ShowActorList { get { return _ShowActorList; } }
        List<ActorDetailViewModel> _ActorList = new List<ActorDetailViewModel>();
        public List<ActorDetailViewModel> ActorList { get { return _ActorList; } }
        string _ActorFilter;
        public string ActorFilter
        {
            get { return _ActorFilter; }
            set
            {
                _ActorFilter = value;
                ShowActorList.Clear();
                ActorList.ForEach(v =>
                {
                    if (IsFit(v.Name, _ActorFilter)) ShowActorList.Add(v);
                });
                if (!ShowActorList.Contains(CurrentActor))
                    CurrentActor = null;
            }
        }
        ...
        List<EventDetailViewModel> _EventList = new List<EventDetailViewModel>();
        public List<EventDetailViewModel> EventList { get { return _EventList; } }
        ObservableCollection<EventDetailViewModel> _ShowEventList = new ObservableCollection<EventDetailViewModel>();
        public ObservableCollection<EventDetailViewModel> ShowEventList { get { return _ShowEventList; } }
        string _EventFilter;
        public string EventFilter
        {
            ...
            set
            {
                ...
                EventList.ForEach(v =>
                {
                    if (IsFit(v.Name, _EventFilter)) ShowEventList.Add(v);
                });
                if (!ShowEventList.Contains(CurrentEvent))
                    CurrentEvent = null;
            }
        }
        ...
        List<GroupDetailViewModel> _GroupList = new List<GroupDetailViewModel>();
        public List<GroupDetailViewModel> GroupList { get { return _GroupList; } }
        ObservableCollection<GroupDetailViewModel> _ShowGroupList = new ObservableCollection<GroupDetailViewModel>();
        public ObservableCollection<GroupDetailViewModel> ShowGroupList { get { return _ShowGroupList; } }
        string _GroupFilter;
        public string GroupFilter
        {
            ...
            set
            {
                ...
                GroupList.ForEach(v =>
                {
                    if (IsFit(v.Name, _GroupFilter)) ShowGroupList.Add(v);
                });
                if (!ShowGroupList.Contains(CurrentGroup))
                    CurrentGroup = null;
            }
        }
        ...
        List<LocationDetailViewModel> _LocationList = new List<LocationDetailViewModel>();
        public List<LocationDetailViewModel> LocationList { get { return _LocationList; } }
        ObservableCollection<LocationDetailViewModel> _ShowLocationList = new ObservableCollection<LocationDetailViewModel>();
        public ObservableCollection<LocationDetailViewModel> ShowLocationList { get { return _ShowLocationList; } }
        ...
        public string LocationFilter
        {
            ...
            set
            {
                ...
                ShowLocationList.Clear();
                LocationList.ForEach(v =>
                {
                    if (IsFit(v.Name, _LocationFilter)) ShowLocationList.Add(v);
                });
                if (!ShowLocationList.Contains(CurrentLocation))
                    CurrentLocation = null;
            }
        }

        TaskDetailViewModel _CurrentTask;
        public TaskDetailViewModel CurrentTask { get { return _CurrentTask; } set { _CurrentTask = value; CurrentObject = value; OnPropertyChanged("CurrentTask"); } }
        List<TaskDetailViewModel> _TaskList = new List<TaskDetailViewModel>();
        public List<TaskDetailViewModel> TaskList { get { return _TaskList; } }
        ObservableCollection<TaskDetailViewModel> _ShowTaskList = new ObservableCollection<TaskDetailViewModel>();
        public ObservableCollection<TaskDetailViewModel> ShowTaskList { get { return _ShowTaskList; } }
        string _TaskFilter;
        public string TaskFilter
        {
            ...
            set
            {
                ...
                TaskList.ForEach(v =>
                {
                    if (IsFit(v.Name, _TaskFilter)) ShowTaskList.Add(v);
                });
                if (!ShowTaskList.Contains(CurrentTask))
                    CurrentTask = null;
            }
        }
        ...
        List<StuffDetailViewModel> _StuffList = new List<StuffDetailViewModel>();
        public List<StuffDetailViewModel> StuffList { get { return _StuffList; } }
        ObservableCollection<StuffDetailViewModel> _ShowStuffList = new ObservableCollection<StuffDetailViewModel>();
        public ObservableCollection<StuffDetailViewModel> ShowStuffList { get { return _ShowStuffList; } }
        string _StuffFilter;
        public string StuffFilter
        {
            get { return _StuffFilter; }
            set
            {
                _StuffFilter = value;
                ShowStuffList.Clear();
                StuffList.ForEach(v =>
                {
                    if (IsFit(v.Name, _StuffFilter)) ShowStuffList.Add(v);
                });
                if (!ShowStuffList.Contains(CurrentStuff))
                    CurrentStuff = null;
            }
        }
        ...
        FrameworkElement _StoryListView;
        FrameworkElement StoryListView
        {
            get
            {
                if (_StoryListView == null)
                    _StoryListView = new StoryListView() { DataContext = this };
        ...
        public void AddActor()
        {
            ...
            ShowActorList.Add(CurrentActor);
        }
        ...
        public void AddEvent()
        {
            ...
            ShowEventList.Add(CurrentEvent);
            Target.IsChanged = true;
        }
        ...
        public void AddGroup()
        {
            ...
            ShowGroupList.Add(CurrentGroup);
            Target.IsChanged = true;
        }
        ...
        public void AddLocation()
        {
            ...
            ShowLocationList.Add(CurrentLocation);
            Target.IsChanged = true;
        }
        ...
        public void AddStuff()
        {
            ...
            ShowStuffList.Add(CurrentStuff);
            Target.IsChanged = true;
        }
        ...
        {
            var vm = new RelationDetailViewModel() { TargetObject = r };
            Target.TargetStory.RelationList.Add(r);
            RelationList.Add(vm);
            Target.IsChanged = true;
            CurrentRelation = vm;
        }
        ...
        //    }
        //}
        CreateRelationDialog createRelationDialog;
        async void CreateRelation()
        {
            if (createRelationDialog == null)
            {
                createRelationDialog = new CreateRelationDialog();
            }
            createRelationDialog.Clear();

            ContentDialogResult result = await createRelationDialog.ShowAsync();
            if (result == ContentDialogResult.Primary)
            {
                createRelationDialog.CreateRelation();
            }
        }
        ...
        {
            get { if (IsFullScreen) return 0; return Target.AdditionPaneWidth; }
            set { Target.AdditionPaneWidth = value; OnPropertyChanged("AdditionPaneWidth"); }
        }
        ...
        public bool IsFullScreen
        {
            ...
            set
            {
                Target.IsFullScreen = value; OnPropertyChanged("IsFullScreen");
        ...
        public bool IsAdditionPanePinned
        {
            ...
            set
            {
                if (value)
                {
                    AdditionPaneDisplayMode = SplitViewDisplayMode.Inline;
                    IsAdditionPaneOpen = true;
                    
                }
                else
                {
                    AdditionPaneDisplayMode = SplitViewDisplayMode.Overlay;
                    if (IsAdditionPaneOpen)
                        IsAdditionPaneOpen = false;
                }
                Target.IsAdditionPanePinned = value;
                OnPropertyChanged("IsAdditionPanePinned");
            }
        }
        ...
        public object CurrentObject
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    if ((value as MainViewModel) != null)
                    {
        ...
        public void OpenViewInfo(ViewInfo info)
        {
            ...
            if (info.View != null)
            {
                if (!ViewList.Contains(info))
                    ViewList.Add(info);
                if (MainContent.Child == info.View)//already open right view
                {

                }
                else
                {
                    MainContent.Child = info.View;
                    CurrentView = info;
                    CurrentObject = info.View.DataContext;
                    OnPropertyChanged("CurrentView");
                }
        ...
        {
            AdditionPaneWidth = Target.AdditionPaneWidth;
        ...
        {
            PaneDisplayMode = SplitViewDisplayMode.CompactOverlay;
            AdditionPaneDisplayMode = SplitViewDisplayMode.CompactOverlay;
            IsPanePinned = false;
            IsAdditionPanePinned = false;
            IsPaneOpen = false;
            IsAdditionPaneOpen = false;
        }
        ...
        void LoadInfo()
        {
            ...
            //}
            if (Target.CurrentViewIndex >= 0 && Target.CurrentViewIndex < ViewList.Count)
            {
                CurrentView = ViewList[Target.CurrentViewIndex];
            }
            OnPropertyChanged("Title");
            //RefreshEntityList();
        }
        void SaveInfo()
        {
            ...
            Target.CurrentViewIndex = ViewList.IndexOf(CurrentView);
        ...
        public CommonCommand ShowRelativeFateViewCommand
        {
            get
            {
                return new CommonCommand((o) =>
                {
                    var view = new QueryRelativeView() ;
        ...
        public CommonCommand ExitCommand
        {
            get
            {
                return new CommonCommand((o) =>
        ...
        async void Feedback()
        {
            ...
            if (result == ContentDialogResult.Primary)
            {
                var s = feedbackDialog.GetMessage();
                var emailMessage = new EmailMessage();

                emailMessage.Subject = "Story design feedback";
                emailMessage.Body = s;
                var emailRecipient = new EmailRecipient("lynxliu2002@hotmail.com");
        ...
        public CommonCommand FeedbackCommand
        {
            get
            {
                return new CommonCommand((o) =>
        ...
        public async void CreateProject()
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    LoadInfo();
                    if(DiagramList.Any())
                        OpenDiagram(DiagramList.FirstOrDefault());
                    OnPropertyChanged("Name");
        ...
        public BitmapImage GetEntityIconByID(Guid id)
        {
            if (ActorList.Any(v => v.ObjectID == id))
                return ActorList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (EventList.Any(v => v.ObjectID == id))
                return EventList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (ActorList.Any(v => v.ObjectID == id))
                return ActorList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (GroupList.Any(v => v.ObjectID == id))
                return GroupList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (LocationList.Any(v => v.ObjectID == id))
                return LocationList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (StuffList.Any(v => v.ObjectID == id))
                return StuffList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            if (TaskList.Any(v => v.ObjectID == id))
                return TaskList.FirstOrDefault(v => v.ObjectID == id).IconImage;
            return null;
        }
    }
}
