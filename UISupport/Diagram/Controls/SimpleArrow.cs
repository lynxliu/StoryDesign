...
{
    public class SimpleArrow : Control
    {
            ...
            public SimpleArrow()
            {
                this.DefaultStyleKey = typeof(SimpleArrow);
            ...
            protected override void OnApplyTemplate()
            {
                ...
                this.arrowElement = (PolyLineSegment)this.GetTemplateChild(UISupport.Diagram.Controls.SimpleArrow.ArrowElementName);
                this.lineElement = (LineSegment)this.GetTemplateChild(UISupport.Diagram.Controls.SimpleArrow.LineElementName);
                this.arrowStartElement = (PathFigure)this.GetTemplateChild(UISupport.Diagram.Controls.SimpleArrow.ArrowStartElementName);
                this.LinePathFigureElement = (PathFigure)this.GetTemplateChild(UISupport.Diagram.Controls.SimpleArrow.LinePathFigureElementName);
                this.RootElement = (Canvas)this.GetTemplateChild(UISupport.Diagram.Controls.SimpleArrow.rootElementName);
                this.SetPosition();
            }
            #endregion
            ...
            {
                SimpleArrow arrowArcSegment = (SimpleArrow)d;
